...
/**
 * TDNASetOfPoolCategory is a concrete sub-class of CatalogCategory
 * that defines methods and properties specific to the sets of forward 
 * pools stock category where mutagen type is 'TDNA insertion'
 */

public class TDNASetOfPoolsCategory extends CatalogCategory {

    /**
     * Implements abstract method defined in superclass to
     * return "tdna_set_of_pools" as the name of this category
     *
     * @return Name of stock category
     */
    public String getCategoryName() {
        return "tdna_set_of_pools";
    }
     ...
     * are associated to germplasms of type "set_of_pools", with
     * a mutagen type of 'TDNA insertion' and whose name is not
     * like "CSH%"
     *
