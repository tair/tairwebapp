...
/**
 * TransposonSetCategory is a concrete sub-class of CatalogCategory
 * that defines methods and properties specific to the transposon
 * sets of lines stock category
 */

public class TransposonSetCategory extends CatalogCategory {

    /**
     * Implements abstract method defined in superclass to
     * return "transposon_set" as the name of this category
     *
     * @return Name of stock category
     */
    public String getCategoryName() {
        return "transposon_set";
    }
    
    /**
     * Implements abstract method defined in superclass to return
     * SQL query to retrieve stock ids that make up transposon sets
     * stock category.  SQL query will retrieve all stock ids that
     * are associated to germplasms of type "set%", with mutagen of 
     * "transposon insertion" where taxon is Arabidopsis thaliana. Stocks
     * are sorted alphabetically by donor last name and stock number
     *
     ...
     * stock with associated data needed for displaying stock on transposon sets 
     * catalog page.  Associated data for transposon sets includes germplasm,
     * stock donors, species variant (through pedigree), associated clone and
     * vector info.
     *
