...
<span class="header">TAIR WU BLAST Results Help</span>
...
<a name="Description"><B>Description</B></A><BR><BR>
The results of a <a href="/Blast">BLAST</a> query are
...
during the search.
<p>
The graphic display and one-line descriptions give information about
...
identify sequences of similarity.  

<P><HR SIZE=1 NOSHADE WIDTH=95%><P>


<B><a name="graphic">Graphic Display</A></B><BR><BR>
...
<B>HSPs Share a Background Color</B>
<p>
...
<B>How Hits are Chosen for Display</B>
<p>
...
<B>Static and JavaScript Annotations</B>
<p align=left>
...
<a name="oneline"><B>One-line Descriptions</B></A><BR><BR>
...
<a name="alignment"><B>Sequence Alignments</B></A><BR><BR>
...
<a name="parameter"><B>Parameters & Statistics</B></A><BR><BR>
...
information they provide, please refer to the <a
href=http://www.ncbi.nlm.nih.gov/BLAST/blast_help.html>NCBI BLAST
Help Manual</a>.


<P><HR SIZE=1 NOSHADE WIDTH=95%><P>
<a name="accessing"><B>Accessing BLAST Search Results</B></A><BR><BR>

BLAST results can be accessed by entering a sequence of more than
15 characters in the <A href="/cgi-bin/wublast/wublast">BLAST Search</A> Page, then choosing the appropriate BLAST Program.

<P><HR SIZE=1 NOSHADE WIDTH=95%><P>

<a name="links"><B>Other Relevant Links</B></A><BR></BR>
