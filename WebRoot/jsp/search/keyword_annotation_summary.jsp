...
String scope = ( request.getParameter( "scope" ) != null ) ? ( String )request.getParameter( "scope" ) : " ";
String sortColumn = "is_parent_keyword desc"; // sort preference for display of annotations from keyword summary where scope = 'combo'   
ResultsFetcher results = new ResultsFetcher( query_id, summaryType );
results.setPageSize( pageSize );
results.setSort( sortColumn );
//no longer need this. oracle migration now takes care of this with .setsort
//if ( currentPage == 1 ) { // invoke sorting/grouping only before display of first page
//    if ( scope.equalsIgnoreCase( "combo" ) ) {    
//        results.setSort( sortColumn );
//    }
//}
...
<th style="width:30px" class="sm" nowrap>
