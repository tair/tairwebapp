...
<%!
String pageName = "Pooled Genomic DNA Search Results";
String highlight = "1";
%>
<% 
// get results of search
SearchResultsCollection searchCollection = (SearchResultsCollection) request.getAttribute( "searchCollection" );
PooledGenomicSummary[] results = (PooledGenomicSummary[]) searchCollection.getResults();
...
<input type="hidden" name="dna_type" value="pool" />
...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="2">
	...
	<td width="100%"> 
          ...
          <h1>TAIR Pooled Genomic DNA Search Results</h1>
