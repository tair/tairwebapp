...
<input type="hidden" name="dna_type" value="filter" />
...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="2">
	...
	<td width="100%"> 
          ...
          <h1>TAIR Filter Search Results</h1>
	...
	<table width="100%" border="0" cellspacing="0">
	  <tr>
	    ...
	    <td aligh="left" colspan="2"><input type="button" value="Order Checked Stock" onClick="javaScript:mySubmit( 0, 'order', 25)" ></td>
	  </tr>

          <tr align="left" <%=myBgColor.toggleBgColor()%> valign="bottom"> 
            <th class="sm" align="center">Check to<br>Download</th>
            <th class="sm"><a href="/help/helppages/cloneres.jsp#447636">Name/Stock Number</a></th>
	...
	<% for ( int i = 0; i < results.length; i++ ) { %>
	  <tr <%=myBgColor.toggleBgColor()%> valign="top">
      	    ...
      	    <td class="sm" align="left"><%= floor++ %><input type="checkbox" name="id" value="<%= results[ i ].get_stock_id() %>"></td>
            <td class="sm"><a href="/servlet/TairObject?id=<%= results[ i ].get_stock_id() %>&type=stock"><%= results[ i ].get_name() %>&nbsp;</a></td>
            <td class="sm"><%= EmptyTextConverter.convert( results[ i ].get_abbrev_description() ) %>&nbsp;</td>
