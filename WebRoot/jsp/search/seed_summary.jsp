...
<%!
String pageName = "Seed Stock Search Results";
%>
<% 
...
function mySubmit(page_number, action, size, query_id) {
    if ( action == "order" ) {
      ...
      // seed has no stand alone search - go to germplasm search page
      // if requesting a new search
      if ( action == "new_search" ) {
         document.search_result.type.value = "germplasm"
      }
...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="2">
	...
	<td width="100%"> 
          ...
          <h1>TAIR Seed Stock Search Results</h1>
