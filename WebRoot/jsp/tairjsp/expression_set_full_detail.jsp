...
<%!
String pageName = "Expression Set Full Detail";
%>

<% 
ExpressionSetFullDetail detail = (ExpressionSetFullDetail) request.getAttribute( "detail" ); 
%>
...
<table width="100%" border="0" colspan="2" cellspacing="0" >
      <tr> <td colspan="2"><B><font size="+1">Experiment: <%= detail.get_original_name() %></font></B></td>
       </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
    ...
    <tr bgcolor="<%= DataConstants.DARK_BGCOLOR %>">
       <td colspan="2"><font class="formheader">Experiment Summary</font></td>
    </tr>
    <%@ include file="/jsp/includes/expression_set_summary.jsp" %>

    <tr bgcolor="<%= DataConstants.DARK_BGCOLOR %>">
	<td colspan="2"><font class="formheader">Sample Information<%=DefinitionsLookup.createPopupLink("BioSample","class")%></font></td>
    </tr> 
      <%@ include file="/jsp/includes/bio_sample_collection.jsp" %>
    
     <tr bgcolor="<%= DataConstants.DARK_BGCOLOR %>">
	<td colspan="2"><font class="formheader">Slide Information<%=DefinitionsLookup.createPopupLink("HybData","class")%></font></td>
    </tr>
      <%@ include file="/jsp/includes/experi_slides_summary.jsp" %> 
      <%@ include file="/jsp/includes/experi_slides_detail.jsp" %>

     <tr bgcolor="<%= DataConstants.DARK_BGCOLOR %>">
	<td colspan="2"><font class="formheader">Array Information<%=DefinitionsLookup.createPopupLink("HybData","class")%></font></td>
    </tr>
      <%@ include file="/jsp/includes/array_info.jsp" %> 
