...
<%!
String pageName = "Expression Set Detail";
%>

<% 
ExpressionSetDetail detail = (ExpressionSetDetail) request.getAttribute( "detail" ); 
%>
...
<table width="100%" border="0" colspan="2" cellspacing="0" >
     <tr> <td colspan="2"><B><font size="+1">Experiment: <%= detail.get_original_name() %></font></B></td>
      ...
      <tr>
         <td colspan="2">
	  <img src="/images/exp_sum.gif" usemap="#file_map" border="0">
        </td>
      </tr>
