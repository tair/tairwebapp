...
<%  KeywordChildrenAnnotationDetail object = (KeywordChildrenAnnotationDetail) request.getAttribute("detail");
...
<TR>
   <TD colspan="3"><b><font size="+1">Annotations associated with children terms of term: <%=  object.getKeywordName() %> </font></b></TD>
