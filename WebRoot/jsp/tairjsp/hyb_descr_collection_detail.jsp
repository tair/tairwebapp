...
<%!
String pageName = "Hybridization Collection Detail";
%>

<% 
HybDescriptionCollectionDetail detail = (HybDescriptionCollectionDetail) request.getAttribute( "detail" );
%>
...
<table width="100%" border="0" colspan="2" cellspacing="0" >
      ...
      <tr>
        <td colspan="2"> <img src="/images/slides.gif" usemap="#file_map" border="0">
        </TD>
      </tr>
