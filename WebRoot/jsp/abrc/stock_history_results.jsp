...
<table align="center" cellpadding="3" cellspacing="2" border="0">
      <tr>
	<td align="center" class="sm" colspan="4"><font class="mainheader">Stock Order Histories</font></td>
      </tr>
	...
	<form action="/servlets/Order" method="post">
	  ...
	  &nbsp;&nbsp;
	  <input type="button" value="Return to Stock Detail" onClick="document.location.href='/servlets/TairObject?type=stock&name=<%= stockNumber %>'">
	</form>
