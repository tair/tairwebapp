...
<%!
String pageName = "Add Credit Card Payment";
%>
...
<table cellpadding="1" border="0" align="center" width="100%" cellspacing="0">
	<tr>
	  <td class="sm" align="center" colspan="3"><font class="mainheader">Credit Card Payment for Invoice # <%= invoice.get_invoice_id() %></font></td>
	</tr>
	...
	<td class="sm" colspan="3">
	  <% // go through the line item ids and add the total together 
      %>
	  
	    <table>

          <tr>
		<td class="sm" align="right"><font class="formheader">Payment amount:</font></td>
		<td class="sm" align="left"><%= TextConverter.floatToMoneyString( paymentTotal ) %></td>
	      </tr>

	  <% if ( invoice.get_payment_method().equalsIgnoreCase( "credit_card" ) ) {
      %>
	      <tr>
        <td class="sm" ><font class="formheader">Transaction reference number:</font></td>
		<td class="sm" nowrap>
      ...
      %>  
        ...
        <td class="sm" ><font class="formheader">Transaction reference number:</font></td>
		<td class="sm" nowrap>
		  <input type="text" size="40" maxlength="100" name="reference">
		</td>
	      </tr>
	  <% }  
      %>            
