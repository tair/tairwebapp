...
// get results of person's search for non-lab organizations
// to affiliate to
...
<p>
Don't see your organization?  <a href="/servlets/Community?action=edit&type=organization&new=true&searched=true">ADD IT HERE</a>.
...
<table border="0" cellspacing="0" cellpadding="1" width="100%">
    ...
    <tr>
      <td colspan="6" align="center"><br><%= EmptyTextConverter.convert( scrollLinks ) %></td>
    </tr>
