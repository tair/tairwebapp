...
<a href="mailto:curator@arabidopsis.org">curator@arabidopsis.org </A></dd>
...
please follow the suggested format in submitting your data and send the files to: <a href="mailto:curator@arabidopsis.org">curator@arabidopsis.org</A></dd>

<dt><B>Gene Structural Annotations</b></dt>
...
<dt><B>Gene Functional Annotations</b></dt>
<dd><a href="/doc/submit/functional_annotation/123">Gene Functional Annotation Guidelines</A><br>
We encourage users of TAIR to share their functional annotation data with the research community. Please follow the suggested format in submitting your data and send the files to: <a href="mailto:curator@arabidopsis.org">curator@arabidopsis.org</A></dd>
...
To submit data for markers please format your data as described in the above link and send the data as an excel attachment to: <a href="mailto:curator@arabidopsis.org">curator@arabidopsis.org</A></dd>
...
If you would like your gene family to appear on the TAIR <a href="/browse/genefamily/index.jsp" target="display">Arabidopsis Gene Family Information</A> page, please format your data as described in the link above and send it to <a href="mailto:curator@arabidopsis.org">curator@arabidopsis.org</A> as an excel attachment.</dd>


<dt><B>Functional Genomics Gene List Submission</B></dt>
<dd><a href="/submit/submit_2010.jsp">2010 Gene Submission Guidelines</A><br>
If you are working on a group of genes as a part of a functional genomics initiative, we would like to include your gene list in the <A href="/portals/masc/projects.jsp" target="display">2010 Projects</A> section. Please follow the guidelines above and send it to <A href="mailto:curator@arabidopsis.org">curator@arabidopsis.org</A> as an excel attachment.</dd>

<dt><B>Pathway Data Submission</b></dt>
<dd><a href="/submit/pathway_submission.jsp">Pathway Data Submission Guidelines</A><br>
We encourage users of TAIR to share their pathway data with the research community. You can also use this form to update existing pathways. Please follow the above format in submitting your data and send the files to: <a href="mailto:curator@arabidopsis.org">curator@arabidopsis.org</A></dd>
...
further information please see the <a href="/info/microarrayAnnouncement.jsp">full text of our microarray data
announcement</a>.</dd>    
...
TAIR encourages the research community to share their protocols. To submit a protocol to TAIR , please follow the guidelines above and send it to <a href="mailto:curator@arabidopsis.org">curator@arabidopsis.org</A> in .txt, .doc, .jpg, .gif or .pdf format.</dd>

<dt><B>External Link Submission</b></dt>
<dd><a href="/submit/ExternalLinkSubmission.jsp">External Link Submission Guidelines</A><br>
We encourage users of TAIR to submit external links assoiciated to gene loci found in TAIR. Please follow the suggested format in submitting your data and send the files to: <a href="mailto:curator@arabidopsis.org">curator@arabidopsis.org</A></dd>

<dt>Arabidopsis Gene Symbol Registry</dt>
<dd><a href="/portals/nomenclature/symbol_main.jsp">Arabidopsis Gene Symbol Registry Guidelines</a><br>
Register your gene symbol pre-publication.</dd>

<dt><b>Where to Submit Data</b></dt>
<dd><a href="/submit/whereToSubmit.jsp">Table of data types and repositories</a>.
