...
<%
	String pageName = "PHD Gene Family";
	String highlight = "3";
	String helpfile="";
...
<!-- Content goes here //-->
<h2>PHD <i>Arabidopsis</i> Gene Family</h2>
<table width="550">
	<tr><th valign="top">Source:</th> 
	    <td>
		<ul>
		<li><b>Greb T, Mylne JS, Crevillen P, Geraldo N, An H, Gendall AR, Dean C.</b>
		Curr Biol. 2007 Jan 9;17(1):73-8. Epub 2006 Dec 14.
        <a href="/servlets/TairObject?type=publication&id=501720561">
		The PHD Finger Protein VRN5 Functions in the Epigenetic Silencing of
		Arabidopsis FLC.</a>
		</li>
		<li>
		<b>Sung S, Schmitz RJ, Amasino RM.</b>
		Genes Dev. 2006 Dec 1;20(23):3244-8. Epub 2006 Nov 17.
        <a href="/servlets/TairObject?type=publication&id=501720329">
