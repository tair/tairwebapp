...
<%
	String pageName = "ABI3VP1 Transcription Factor Family";
	String highlight = "3";
	String helpfile="";
...
<!-- Content goes here //-->
<h2>ABI3VP1 Transcription Factor Family</h2>
<table>
