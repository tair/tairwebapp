...
<div id="rightcolumn">
<!-- CONTENT IN HERE -->
<p class="mainheader"><a name="Top"></a>Archives: All pathways deleted from the database (AraCyc 3.5) </p>
...
<p>Return to the <a href="../archives.jsp"><strong>main Archives' page</strong></a>.</p><table width="100%"  border="0">
  <tr>
    <td width="42%">&nbsp;</td>
