...
<!-- AraCyc 4.1-->
<%String pageName = "Archives AraCyc 4.1 - Statictics";
String highlight = "4";
String helpfile="";
...
<p class="mainheader"><span class="mainheader">Archives: Statistics for this release (4.1)</span></p>
...
<tr><td><table width="70%"  border="0" align="left">
  <tr bgcolor="#F4EAEA">
    ...
    <td width="10%"> <div align="center"><em><strong>283</strong></em></div></td>
    </tr>
  <tr bgcolor="#F4EAEA">
    <td width="90%">... with experimental evidence:</td>
    <td width="10%"><div align="center">256</div></td>
    </tr>
  <tr bgcolor="#FFEFEA">
...
<p><strong><em>Last modified:</em></strong> <em>October 5, 2007 </em></p>
