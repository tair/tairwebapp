...
<!-- AraCyc 3.5-->
<%String pageName = "Archives AraCyc 4.1 - Deleted pathways";
String highlight = "4";
String helpfile="";
...
<p class="mainheader">Archives: Pathways deleted from the database in AraCyc 4.1</p>
...
<strong><em>Last modified</em>:</strong> <em>September 4, 2007 </em></div>
