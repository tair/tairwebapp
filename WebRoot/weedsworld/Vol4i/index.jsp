...
<TABLE width="90%">
        ...
        <tr>
          <td colspan=3 align=center><H1>Weeds World Volume 4(i)</h1></td>
        </tr>
        <tr>
          <td colspan=3 align=center><h1>ISSN 1358-6912</h1></td>
        </tr>
        <tr>
          <td colspan=3>Editor: Mary Anderson, NASC, University of Nottingham, UK<br></td>
        </tr>
        <tr>
          <td colspan=3>WWW mirror site curator: David Flanders, Stanford AtDB Project<br></td>
        </tr>
        <tr>
          <td colspan=3 >WWW mirror site curator: Doug Bigwood, Genome Informatics Group, NAL<br></td>
        </tr>
        <tr>
          <td colspan=3>Markup: Mike Arnold, NASC, University of Nottingham, UK <P></td>
        </tr>
        <tr>
      ...
      <blockquote>
        <bodytext>
          ...
          <table>
            <tr>
              <td bgcolor="#cccccc" wdith="30%"><font color="#790000"><b>Conference Summaries</b></font></td>
            </tr>
          </table>
